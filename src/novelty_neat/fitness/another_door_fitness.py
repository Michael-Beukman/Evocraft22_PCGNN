...
class AnotherDoorFitness(NeatFitnessFunction):
    def __init__(self, 
        ...
        def calc_fitness(level: Level):
            ...
            def has_door(single_face: np.ndarray):
                ...
                if how_many_tiles == 2: 
                    ...
                    how_many_good = 1 / how_many_tiles**2
                ...
                if len(counts) > 0:
                    ONLY_TWO = ONLY_TWO / len(counts)**2
                ...
                if len(counts) == 1:
                    ...
                    how_many_things = 1 / len(counts)**2
