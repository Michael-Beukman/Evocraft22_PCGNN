...
class AnotherDoorFitnessLinear(NeatFitnessFunction):
    def __init__(self, 
    ...
    def __repr__(self) -> str:
        return f"AnotherDoorFitnessLinear(number_of_levels_to_generate={self.number_of_levels}, level_gen={self.level_gen})"
