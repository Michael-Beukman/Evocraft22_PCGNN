...
class MyRoofFitnessV2(NeatFitnessFunction):
    def __init__(self, 
    ...
    def calc_fitness(self, nets: List[LevelNeuralNet], levels: List[List[Level]]) -> List[float]:
        ...
        def calc_fitness(level: Level):
            ...
            return (how_much_cover + how_much_connected + 4*(1 - how_many_tiles) + 1 - bads) / 7
    ...
    def __repr__(self) -> str:
        return f"MyRoofFitnessV2(number_of_levels_to_generate={self.number_of_levels}, level_gen={self.level_gen})"
