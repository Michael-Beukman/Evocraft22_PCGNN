...
class TownLarger_ReachableMore_Fitness2(NeatFitnessFunction):
    def __init__(self, 
    ...
    def calc_fitness(self, nets: List[LevelNeuralNet], levels: List[List[Level]]) -> List[float]:
        ...
        def calc_fitness(level: Level):
            ...
            return (np.clip((A + B) / 2, 0, 1) + goods * 2) / 3
    ...
    def __repr__(self) -> str:
        return f"TownLarger_ReachableMore_Fitness2(number_of_levels_to_generate={self.number_of_levels}, level_gen={self.level_gen})"
