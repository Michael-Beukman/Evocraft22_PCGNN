...
class TownLarger_ReachableMore_Fitness3(NeatFitnessFunction):
    def __init__(self, 
    ...
    def __repr__(self) -> str:
        return f"TownLarger_ReachableMore_Fitness3(number_of_levels_to_generate={self.number_of_levels}, level_gen={self.level_gen})"
